...
def generate_config_ini():
    ...
    # Set API section
    config['API'] = {
        'api_link':'https://archive-api.open-meteo.com/v1/archive?start_date=2022-01-01&end_date=2023-08-05&hourly=temperature_2m,relativehumidity_2m,precipitation,weathercode,cloudcover,windspeed_10m,winddirection_10m'
